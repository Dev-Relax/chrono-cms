...
export const DEFAULT_SIDEBAR_WIDGETS: SidebarWidget[] = [
  {
    id: "about", type: "about", enabled: true, title: "About",
  ...
  { id: "recent_posts", type: "recent_posts",  enabled: false, title: "Recent Posts", count: 5 },
  { id: "social_links", type: "social_links",  enabled: false, title: "Follow",       links: [] },
  { id: "custom_text",  type: "custom_text",   enabled: false, title: "Custom",       text: ""  },
];
