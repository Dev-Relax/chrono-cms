              ...
              {(post.hreflang?.length ?? 0) > 1 && (
                <>
                  ...
                  <div ref={langRef} className="relative">
                    ...
                    {langOpen && (
                      <div className="absolute left-0 top-full z-30 mt-1.5 min-w-[130px]
                                      rounded-xl border border-slate-700 bg-slate-900 shadow-xl">
                        <p className="px-3 pt-2.5 pb-1 text-[9px] font-semibold uppercase
                        ...
                        {post.hreflang?.map(({ locale, slug: localeSlug }) => {
                          ...
                          return (
                            <button
                              ...
                              onClick={() => {
                                setLangOpen(false);
                                if (!isActive) startTransition(() => navigate(`/posts/${localeSlug}`));
                              }}
                              className={[
                            ...
                            >
                              ...
                              <span className="font-mono text-xs font-bold">{locale.toUpperCase()}</span>
                              {isActive && (
