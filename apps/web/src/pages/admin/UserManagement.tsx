...
const EditRow: React.FC<{
  ...
  const inputCls =
    "rounded border border-slate-700 bg-slate-800 px-2 py-1 text-xs text-slate-200 focus:border-brand-500 focus:outline-none w-full"
...
const UserManagement: React.FC = () => {
  ...
  const inputCls =
    "w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-slate-200 placeholder-slate-600 focus:border-brand-500 focus:outline-none"
