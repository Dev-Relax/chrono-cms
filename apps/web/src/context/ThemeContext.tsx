...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <ThemeContext.Provider
      value={{
        savedTheme, draftTheme, setDraftTheme, saveTheme,
        savedBrand, draftBrand, setDraftBrand, saveBrand,
        savedNav, setNav, saveNav,
        isSaving, isDirty, isBrandDirty, isNavDirty, isLoading,
      }}
    >
      {children}
    </ThemeContext.Provider>
