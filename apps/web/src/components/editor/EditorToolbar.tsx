...
const icons = {
  ...
  unlink:
    "M18.84 12.25l1.72-1.71a4.87 4.87 0 1 0-6.88-6.9l-1.72 1.72M6.15 11.74l-1.72 1.71a4.87 4.87 0 1 0 6.88 6.9l1.72-1.72M5 5l14 14",
  ...
  video:
    "M15 10l4.553-2.277A1 1 0 0 1 21 8.68v6.641a1 1 0 0 1-1.447.894L15 14M3 8a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",
  file: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8",
  markdown:
    "M3 5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H3zm3 7l2 2 2-2m2 0v-4m2 4l2-2 2 2",
...
const LinkPopover: React.FC<{ editor: Editor }> = ({ editor }) => {
  ...
  useEffect(() => {
    if (open && tab === "pages" && pages.length === 0) {
      pagesApi
        .list()
        .then(({ data }) => setPages(data.map((p) => ({ id: p.id, slug: p.slug, title: p.title }))))
        .catch(() => {
          /* ignore */
        })
    }
          ...
          >
            ...
            <div className="p-5">
              <p className="mb-3 text-xs text-slate-500">
                Paste Markdown below. This will <strong className="text-slate-300">replace</strong>{" "}
                the current content.
              </p>
              <textarea
                autoFocus
  ...
  return (
    <div
      className="flex flex-wrap items-center gap-0.5
                    border-b border-slate-700 bg-slate-900 px-2 py-1.5"
    >
      <Btn
        title="Undo (Ctrl+Z)"
      ...
      <select
        value={getBlock(editor)}
        onChange={(e) => applyBlock(editor, e.target.value as BlockVal)}
        ...
        <MediaPickerModal
          ...
          onSelectImage={(sel: ImageSelection) => {
            ...
            ;(editor.chain().focus() as any)
              .setImage({ src: sel.url, alt: sel.alt, caption: sel.caption })
              .run()
          }}
