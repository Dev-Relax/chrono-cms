...
const MOCK_POSTS = [
  { title: "Getting Started with TypeScript",   tag: "Dev",     date: "Mar 10", excerpt: "A practical guide to setting up a strict TypeScript project from scratch with best-practice tooling." },
  { title: "Design Systems at Scale",           tag: "Design",  date: "Mar 8",  excerpt: "How to build a token-based design system that adapts to any brand with zero code changes." },
  { title: "Deploying with Docker Compose",     tag: "DevOps",  date: "Mar 5",  excerpt: "From local development to production in minutes — a step-by-step containerisation walkthrough." },
] as const;
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
          ...
          <span style={{ fontSize: 11, color: "#475569", fontFamily: "var(--font-main)" }}>
            {post.date}
          </span>
        </div>
        <h3 style={{
    ...
    case "about":
      return (
        <div style={widgetCardStyle}>
          ...
          <p style={{ fontFamily: "var(--font-main)", fontSize: 11, color: "#94a3b8", lineHeight: 1.6, margin: 0 }}>
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ fontFamily: "var(--font-main)", fontSize: 14, color: "#64748b", margin: 0 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            gridTemplateColumns: isGrid
              ? showSidebar ? "repeat(2, 1fr)" : "repeat(3, 1fr)"
              : undefined,
