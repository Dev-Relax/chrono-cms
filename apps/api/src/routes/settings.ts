  ...
  fastify.put(
    ...
    async (request, reply) => {
      const body = z.object({
        ...
        (d) => d.themeConfig !== undefined || d.brandConfig !== undefined || d.navConfig !== undefined,
      ...
      if (body.data.themeConfig) updateData["themeConfig"] = body.data.themeConfig as unknown as Prisma.InputJsonValue;
      if (body.data.brandConfig) updateData["brandConfig"] = body.data.brandConfig as unknown as Prisma.InputJsonValue;
      if (body.data.navConfig)   updateData["navConfig"]   = body.data.navConfig   as unknown as Prisma.InputJsonValue;
