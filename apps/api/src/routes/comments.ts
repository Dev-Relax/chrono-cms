...
export const commentsRoutes = async (fastify: FastifyInstance): Promise<void> => {
  fastify.get<{ Params: { postId: string } }>("/posts/:postId/comments", async (req, reply) => {
  ...
  fastify.post<{ Params: { postId: string } }>("/posts/:postId/comments", async (req, reply) => {
    const { postId } = req.params
  ...
  fastify.get("/admin/comments", { preHandler: fastify.authenticate }, async (req, reply) => {
  ...
  fastify.post("/admin/comments/bulk", { preHandler: fastify.authenticate }, async (req, reply) => {
